...
<body>
    ...
    <div class="page">
        <div class="categorie">
            <div class="btns">
                ...
                <a href="add_collection.php" class="categorie-btn">Collection</a>
            </div>
            <p>*Champs obligatoires</p>
        </div>
        <div class="formulaire">
            <form action="add_earrings.php" method="POST" enctype="multipart/form-data">
                <?php include ('../../model/ajouter_earrings.php'); ?>
                <div class="champs">
                    <div class="caracteristiques">
                        ...
                        <div class="input-group">
                            <label for="motif">Motif / Forme</label>
                    ...
                    <div class="pierres">
                        ...
                        <div class="pierre principale" id="pierrep">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="pnombre" min="1" step="1">
                            </div>
                            <div class="input-group">
                            ...
                            <div class="input-group">
                                <label for="psertis">Sertis*</label>
                                <input type="text" name="psertis">
                            </div>
                        </div>
                        <div class="check secondaire">
                            <input type="checkbox" id="checks" name="checks">
                            <p>Pierre secondaire</p>
                        </div>
    ...
    <!-- <script>
        ...
        let checkdisplay = document.querySelector('.check.secondaire');
        let inputp = document.querySelector('#pierrep');
        let inputs = document.querySelector('#pierres');
        checkp.onclick =function(){
            if(inputp.style.display === 'block' && checkdisplay.style.display === 'flex') {
