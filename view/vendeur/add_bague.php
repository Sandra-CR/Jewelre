...
<body>
    ...
    <div class="page">
        <div class="categorie">
            <div class="btns">
                <a href="add_bague.php" class="categorie-btn active">Bagues</a>
        ...
        <div class="formulaire">
            <form action="add_bague.php" method="POST" enctype="multipart/form-data">
                <?php include ('../../model/ajouter_bague.php'); ?>
                <div class="champs">
                    ...
                    <div class="tailles-stock">
                        ...
                        <div class="input-group">
                            <label for="longueur">Tour de doigt</label>
                            <input type="number" name="tourdoigt" min="40" max="80" step="1">
                        </div>
                        <div class="input-group">
