    ...
    <div class="page">
        <div class="categorie">
            <div class="btns">
                ...
                <a href="add_bracelet.php" class="categorie-btn active">Bracelets</a>
        ...
        <div class="formulaire">
            <form action="add_bracelet.php" method="POST" enctype="multipart/form-data">
                <?php include ('../../model/ajouter_bracelet.php'); ?>
                <div class="champs">
