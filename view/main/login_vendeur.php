    ...
    <div class="container" id="container">
        <div class="form-container connexion">
            <form action="" method="POST">
                ...
                <?php include ('../../model/connexion_vendeur.php'); ?>
                ...
                <div class="links">
                    <a href="reset_password_request.php?type=vendeur" class="forgot-link">Mot de passe oublié</a>
                    <a href="signin_vendeur.php">Je n'ai pas encore de compte</a>
                </div>
                <!-- Bouton submit -->
