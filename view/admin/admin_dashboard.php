...
<?php 
    if($_SESSION['adminID'] === 0) { 
        $allowedTables = ['administrateur', 'client', 'adresse', 'fournisseur', 'commande', 'produit', 
        'produit_suplement', 'produit_taille', 'collection', 'commentaire'];
    } else {
    $allowedTables = ['client', 'adresse', 'fournisseur', 'commande', 'produit', 
    'produit_suplement', 'produit_taille', 'collection', 'commentaire'];
    }
