<?php
                            ...
                            if($smatiere === "" || $scouleur === "" || $snombre === "" || $ssertis === "") {
                                ...
                                if(!isset($_POST['engagement'])) {
                                    ...
                                    if(isset($_POST['envente']) && ($qt1 === "" || $qt1 === '0')) {
                                        ...
                                        $id_produit = ajouterProduit($conn, $type, $prix, $envente, $titrage, $matierep, $couleurp, $matieres, $couleurs, $motif, $chaine, $fermoir, $genre, $_SESSION['idVendeur']);
                                        ...
                                        header("Location: add_bracelet.php");
                                        exit();
                                    }
                                }
                            }
    ...
    function ajouterProduit($conn, $type, $prix, $envente, $titrage, $matierep, $couleurp, $matieres, $couleurs, $motif, $chaine, $fermoir, $genre, $idVendeur) {
        $stmt = $conn->prepare("INSERT INTO produit (type_produit, prix, en_vente, sortie, titrage, 
        matiere_p, couleur_p, matiere_s, couleur_s, motif, chaine, fermoir, id_genre, id_fournisseur) VALUES (:type_produit, :prix, :en_vente, 
        CURDATE(), :titrage, :matiere_p, :couleur_p, :matiere_s, :couleur_s, :motif, :chaine, :fermoir, :genre, :vendeur)");
